...
SHLIB_EXT=
PLATFORM=VC-WIN32
OPTIONS=enable-mdc2 enable-threads enable-zlib no-ec_nistp_64_gcc_128 no-gmp no-idea no-jpake no-krb5 no-md2 no-rc5 no-rfc3779 no-sctp no-shared no-store no-zlib-dynamic
